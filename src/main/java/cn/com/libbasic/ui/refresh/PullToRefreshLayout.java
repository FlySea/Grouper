package cn.com.libbasic.ui.refresh;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.refresh_reverse_anim);
        // 添加匀速转动动画
...
//        refreshingAnimation.setInterpolator(lir);
    ...
    public void refreshFinish(int refreshResult) {
        ...
        if(refreshingAnimation.isRunning()){
...
//        }
    ...
    private void initView() {
        // 初始化下拉布局
        refreshStateTextView = (TextView) refreshLayout.findViewById(R.id.state_tv);
        refreshingView = (ImageView) refreshLayout.findViewById(R.id.refreshing_icon);
        refreshingAnimation = (AnimationDrawable)refreshingView.getBackground();
        // 初始化上拉布局
        loadStateTextView = (TextView) loadmoreLayout.findViewById(R.id.loadstate_tv);
        loadingView = (ImageView) loadmoreLayout.findViewById(R.id.loading_icon);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (!isLayout) {
            ...
            loadmoreLayout = getChildAt(2);
            isLayout = true;
            initView();
            refreshDist = ((ViewGroup) refreshLayout).getChildAt(0).getMeasuredHeight();
            loadmoreDist = ((ViewGroup) loadmoreLayout).getChildAt(0).getMeasuredHeight();
            refreshLayout.layout(0, (int) (pullDownY + pullUpY) - refreshLayout.getMeasuredHeight(), refreshLayout.getMeasuredWidth(), (int) (pullDownY + pullUpY));
            ...
            loadmoreLayout.layout(0, (int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight(), loadmoreLayout.getMeasuredWidth(), (int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight() + loadmoreLayout.getMeasuredHeight());
        }
        // 设置不上拉
        if (!mCanPull) {
